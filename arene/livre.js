...
//  Textes repris du livre imprimé (TEXTE_IMPRIME_V12) : page du duel (p) et page de la réponse (pv).
// =====================================================================
const DUELS = [
  { n: 3, lieu: 'AFRIQUE CONTRE ASIE', q: 'LION OU TIGRE ?', a: 'lion', b: 'tigre', noms: ['LION', 'TIGRE'], arene: 'colisee', p: 9, pv: 10,
    intro: 'Le roi des animaux contre le seigneur de la jungle. Dans la nature, ils ne se croisent plus. Mais face à face… un contre un, qui gagne ?',
    ...
    rep: { g: 'tigre', titre: 'L’AVIS DES EXPERTS', cri: 'LE TIGRE !', punch: 'Tout seul, le roi perd sa couronne !', tampon: 'bleu', label: 'JAMAIS VU DANS LA NATURE',
      film: 'Le tigre pèse environ 30 kg de plus que le lion. Mais attention : un lion vient rarement seul. À deux ou trois, les lions battraient le tigre !' } },
  { n: 5, lieu: 'RIVIÈRE', q: 'HIPPOPOTAME OU CROCODILE DU NIL ?', a: 'hippo', b: 'croco', noms: ['HIPPOPOTAME', 'CROCODILE DU NIL'], arene: 'riviere', p: 13, pv: 14,
    ...
    fiches: [['jusqu’à 3 200 kg', 'des crocs géants', 'il charge gueule ouverte', 'sa peau se fendille au soleil'], ['jusqu’à 750 kg', 'une morsure qui serre fort', 'il attaque caché sous l’eau', 'un élastique lui ferme la gueule']],
    ...
    rep: { g: 'hippo', titre: 'LA VRAIE RÉPONSE', cri: 'L’HIPPOPOTAME !', punch: 'Trois tonnes de mauvaise humeur.', tampon: 'vert', label: 'FILMÉ OU PHOTOGRAPHIÉ',
      film: 'Un crocodile s’approche d’un bébé hippo : tout le troupeau se serre autour du petit. Mordu plusieurs fois, le croco disparaît sous l’eau.' } },
  { n: 6, lieu: 'GRAND NORD', q: 'OURS POLAIRE OU GRIZZLY ?', a: 'ours', b: 'grizzly', noms: ['OURS POLAIRE', 'GRIZZLY'], arene: 'banquise', p: 15, pv: 16,
    ...
    fiches: [['de 350 à 545 kg', 'des griffes en crochet', 'un coup de patte de géant', 'il chauffe vite en courant'], ['environ 180 kg', 'des griffes de 6 cm', 'il attrape les saumons au vol', 'deux à trois fois plus léger']],
    ...
    rep: { g: 'grizzly', titre: 'LA VRAIE RÉPONSE', cri: 'LE GRIZZLY !', punch: 'Un grizzly arrive… et la plage se vide !', tampon: 'vert', label: 'COMPTÉ PAR DES CHERCHEURS',
      film: 'Une quinzaine d’ours polaires se régalent sur la plage. Un grizzly arrive, tranquille… et, sans même grogner, il les fait tous filer, sauf un !' } },
  { n: 8, lieu: 'SAVANE', q: 'LION OU RATEL ?', a: 'lion', b: 'ratel', noms: ['LION', 'RATEL'], arene: 'desert', p: 19, pv: 20,
    intro: 'Sur Internet, des vidéos montrent le ratel, une sorte de blaireau d’Afrique, tenir tête à des lions. Treize kilos de rage contre presque deux cents. Des chercheurs sont allés vérifier. Alors, qui gagne ?',
    fiches: [['environ 190 kg', 'des griffes de 3,8 cm', 'il plaque sa proie au sol', 'il chasse mal en plein jour'], ['jusqu’à 13 kg', 'de longues griffes', 'la bombe puante', 'surpris, il fonce sans réfléchir']],
    gigi: { pari: 'ratel', dit: 'Le ratel !', pourquoi: 'J’ai vu la vidéo : il est INVINCIBLE.', apres: 'Internet m’a menti. Je suis très déçu.' },
    rep: { g: 'lion', titre: 'LA VRAIE RÉPONSE', cri: 'LE LION !', punch: 'Courageux, oui. Invincible, non.', tampon: 'vert', label: 'OBSERVÉ DANS LA NATURE',
      film: 'Dans le désert du Kalahari, des lions ont tué des ratels. Son vrai talent ? Il ne gagne pas : il dégoûte. Il mord, il pue… et souvent, le fauve laisse tomber !' } },
  { n: 10, boss: 1, lieu: 'ÎLE DE KOMODO', q: 'DRAGON DE KOMODO OU BUFFLE ?', a: 'komodo', b: 'buffle', noms: ['DRAGON DE KOMODO', 'BUFFLE D’EAU'], arene: 'jungle', p: 23, pv: 24,
    intro: 'Voici le plus gros lézard du monde : trois mètres de long. Il attaque un buffle sept fois plus lourd que lui. Qui gagne le combat ?',
    ...
    rep: { g: 'buffle', titre: 'LA VRAIE RÉPONSE', cri: 'LE BUFFLE !', punch: 'Mordu, mais pas vaincu !', tampon: 'vert', label: 'OBSERVÉ DANS LA NATURE',
  ...
  { n: 13, lieu: 'BANQUISE', q: 'OURS POLAIRE OU MORSE ?', a: 'ours', b: 'morse', noms: ['OURS POLAIRE', 'MORSE'], arene: 'banquise', p: 31, pv: 32,
    intro: 'Le roi de la banquise sent un phoque à plus d’un kilomètre, même caché sous la neige. Aujourd’hui, il a trouvé mieux : une plage couverte de morses. Qui gagne ?',
    ...
    rep: { g: 'morse', titre: 'LA VRAIE RÉPONSE', cri: 'LE MORSE !', punch: 'Pas touche au troupeau !', tampon: 'vert', label: 'COMPTÉ PAR DES CHERCHEURS',
      film: 'Les morses adultes font un mur, défenses en avant. L’ours freine. Sur 25 attaques d’ours contre des morses, 23 ont raté !' } },
  { n: 18, lieu: 'SAVANE', q: 'HYÈNE OU LION ?', a: 'hyene', b: 'lion', noms: ['HYÈNE TACHETÉE', 'LION'], arene: 'savane', p: 41, pv: 42,
    intro: 'Ce soir, une hyène tombe nez à nez avec un lion mâle. Ils se fixent. Qui fait reculer l’autre ?',
    fiches: [['environ 60 kg', 'des mâchoires à broyer l’os', 'elle épuise ses proies', 'son vacarme attire les voleurs'], ['environ 190 kg', 'des crocs de 7 cm', 'un coup de patte mortel', 'un cœur tout petit pour sa taille']],
    ...
    rep: { g: 'lion', titre: 'LA VRAIE RÉPONSE', cri: 'LE LION !', punch: 'Rira bien qui rira le dernier.', tampon: 'vert', label: 'COMPTÉ PAR DES CHERCHEURS',
      film: 'Une hyène seule n’a aucune chance : un coup de patte peut la tuer. Mais en bande, les hyènes volent le repas des lionnes !' } },
  { n: 24, lieu: 'FORÊT RUSSE', q: 'OURSE BRUNE OU TIGRE DE SIBÉRIE ?', a: 'grizzly', b: 'tigre', noms: ['OURSE BRUNE', 'TIGRE DE SIBÉRIE'], arene: 'banquise', p: 55, pv: 56,
    ...
    fiches: [['presque 200 kg', 'des griffes de 6 cm', 'un coup de patte énorme', 'plus petite que les mâles'], ['Dima : 206 kg', 'des griffes de 10 cm', 'il mord la nuque', 'un gros ours lui vole ses proies']],
    gigi: { pari: 'tigre', dit: 'Pile, le tigre.', pourquoi: 'Face, l’ourse… Pile !', apres: 'Ma pièce ne se trompe jamais. Je la garde.' },
    rep: { g: 'tigre', titre: 'CE QUE DISENT LES INDICES', cri: 'LE TIGRE !', punch: 'Un bond, une morsure : l’ourse n’a rien vu venir.', tampon: 'bleu', label: 'DÉDUIT DES INDICES',
      film: 'Des chercheurs suivaient Dima, un tigre de 206 kg, grâce à son collier GPS. Les traces le disent : il a bondi du haut d’un talus.' } },
  { n: 30, boss: 3, lieu: 'LA GRANDE FINALE', q: 'TIGRE OU GORILLE ?', a: 'tigre', b: 'gorille', noms: ['TIGRE DE SIBÉRIE', 'GORILLE'], arene: 'colisee', p: 67, pv: 68,
    ...
    fiches: [['environ 180 kg', 'les plus longs crocs des félins', 'la morsure à la gorge', 'il rate 9 attaques sur 10'], ['jusqu’à 180 kg', 'de longues canines', 'il charge en hurlant', 'il ne chasse jamais']],
    ...
    rep: { g: 'tigre', titre: 'NOTRE VERDICT', cri: 'LE TIGRE !', punch: 'Crocs 2, biceps 1… et ça se discute !', tampon: 'violet', label: 'DUEL IMAGINÉ',
      film: 'Round 1, l’embuscade : pour le tigre. Round 2, la riposte : pour le gorille. Round 3, le métier : le tigre chasse pour vivre, le gorille jamais.' } },
];
