...
function etourdit(f) {
  ...
  if (f.paralyse) { sfx('boing', .8); addFx({ k: 'mot', x: f.x, y: FLOOR - 760 * f.d.K / .44, mot: hasard(['PARALYSÉ !', 'PLUS UN GESTE !', 'FIGÉ PAR LE VENIN !']), col: '#D9B3FF' }); return } // guêpe, scolopendre : le venin qui paralyse
